...
<head>
    ...
    <script src="http://peopleproconsultants.com/ppltech/ums/js/jquery-1.12.4.min.js"></script>
    <script src="http://peopleproconsultants.com/ppltech/ums/js/jquery-ui.min.js"></script>
    <?= Html::csrfMetaTags() ?>
