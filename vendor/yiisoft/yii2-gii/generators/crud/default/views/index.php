						...
						<section class="panel">
							...
							<div class="panel-body">
								<div class="row">
									<div class="col-sm-6">
										<div class="mb-md">
											<?= "<?= " ?>Html::a(<?= $generator->generateString('Add ' . Inflector::camel2words(StringHelper::basename($generator->modelClass)).' '.'<i class="fa fa-plus"></i>') ?>, ['create'], ['class' => 'btn btn-success']) ?>
										</div>
                                        </div>
