        ...
        b = a.extend(c, b), this.each(function() {
            ...
            a.each(a(c).find("ul > li"), function() {
                ...
                if (a(this).is("li:has(ul)")) {
                    ...
                    //console.log(c), 
                    a(c).remove(), b = a(this).text(), a(this).html('<span><span class="glyphicon"></span><a href="javascript: void(0);" class="nodeClass"></a> </span>'), a(this).find(" > span > span").addClass("glyphicon-folder-open"), a(this).find(" > span > a").text(b), a(this).append(c)
                } else b = a(this).text(), a(this).html('<span><span class="glyphicon"></span><a href="javascript: void(0);" class="nodeClass"></a> </span>'), a(this).find(" > span > span").addClass("glyphicon-file"), a(this).find(" > span > a").text(b)
                ...
                var e = g();
                if (e.length <= 0) a(c).prepend(d), a(c).find(".alert .alert-content").html(b.i18n.editNull);
                else if (e.length > 1) a(c).prepend(d), a(c).find(".alert .alert-content").html(b.i18n.editMultiple);
                else {
